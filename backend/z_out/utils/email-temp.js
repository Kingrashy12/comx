...
exports.PasswordChangeTemp = exports.OtpTemp = void 0;
const OtpTemp = (name, code) => `
...
`;
exports.OtpTemp = OtpTemp;
const PasswordChangeTemp = (name) => `
  <div style="font-family: Arial, sans-serif; text-align: center; padding: 20px;">
    <img src="https://res.cloudinary.com/dv4mozbaz/image/upload/v1740137099/jpqd3kask5xbom4e4ecu.png" />
    <h2 style="color: #333;">Hello, ${name} 👋</h2>
...
`;
exports.PasswordChangeTemp = PasswordChangeTemp;
